...
public class DeleteAllPage {
	...
	private static DeleteAllPage DeleteAllPageObjects;

	private DeleteAllPage() {};
	Common commonFunctions = new Common();
	public static DeleteAllPage getInstance() {

		if(DeleteAllPageObjects==null) {
			DeleteAllPageObjects= new DeleteAllPage ();
		}
